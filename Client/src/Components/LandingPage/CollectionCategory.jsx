                ...
                return (
                    <Drawer key={index}>
                        <DrawerTrigger asChild>
                            ...
                            >
                                {IconComponent ? <IconComponent size={80} className="text-white" /> : null} 
                                {company}
                            </Button>
                        </DrawerTrigger>
                        <DrawerContent>
                            <div className="mx-auto w-full p-4">
                                <DrawerHeader>
                                    <DrawerTitle>
                                        Explore the collection of the top tech questions asked at {company}
                                    </DrawerTitle>
                                    <DrawerTitle>
                                        <Button onClick={() => handleClick(company)}>Explore <FaArrowRight></FaArrowRight></Button>
                                    </DrawerTitle>
                                </DrawerHeader>
                                <DrawerClose asChild>
